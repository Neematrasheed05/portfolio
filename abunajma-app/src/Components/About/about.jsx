...
useEffect(() => {
  ...
  return (
    ...
    <div class="row">
      <div class="col-12">
        <p class="text-center">A pioneering Islamic children's show that airs weekly on Horizon TV Kenya, offering an engaging half-hour filled with interactive Islamic lessons, games, activities, and storytelling.</p>
